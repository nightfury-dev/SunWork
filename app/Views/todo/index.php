    ...
    <div class="card">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php 
                    echo modal_anchor(get_uri("labels/modal_form"), "<i data-feather='tag' class='icon-16'></i> " . app_lang('manage_labels'), array("class" => "btn btn-default", "title" => app_lang('manage_labels'), "data-post-type" => "to_do")); 
                    echo modal_anchor(get_uri("todo/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_todo'), array("class" => "btn btn-default", "title" => app_lang('add_todo')));
                ?>
    ...
    $(document).ready(function () {
        $("#todo-table").appTable({
            ...
            columns: [
                ...
                {title: '<?php echo app_lang("title"); ?>', "class": "w200"},
                {visible: false, searchable: false},
