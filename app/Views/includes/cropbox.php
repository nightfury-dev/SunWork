    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer clearfix">
                <button id="image-zoomout-button" type="button" class="btn btn-default float-start mr10">
                    <i data-feather="minus" class="icon-16"></i></button>
                <button id="image-zoomin-button" type="button" class="btn btn-default float-start">
                    <i data-feather="plus" class="icon-16"></i></button>

                <button type="button" id="image-crop-cancel" class="btn btn-default">  
                    <i data-feather="x" class="icon-16"></i> <?php echo app_lang("close"); ?></button>
                <button id="image-crop-button" type="button" class="btn btn-primary"> 
                    <i data-feather="check-circle" class="icon-16"></i> <?php echo app_lang("crop"); ?></button>
            </div>
        </div>
    </div>
</div>
...
$(document).ready(function() {
    ...
    $("#image-crop-cancel").on('click', function() {
        $('#cropModal').removeClass('show');
        $("#cropModal").css('display', 'hidden');
    })
